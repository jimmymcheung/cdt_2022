...
/* Created on:     15-11-2022 13:22:42                          */
/*==============================================================*/
...
drop index TRUST_ARTICLE_FK;

drop index ARTICLE_TRUST_CRITERIA_PK;

drop table ARTICLE_TRUST_CRITERIA;

drop index GT_FILE_PK;

drop table GT_FILE;

drop index GT_DATA_FK;

drop index GT_FILE_DATA_PK;

drop table GT_FILE_DATA;

drop index ID_SEARCH_PK;

drop table ID_SEARCH;

drop index ARTICLE_PROBABILITIES_FK;

drop index PROBABILITIES_PK;

drop table PROBABILITIES;

drop index RSID_ARTICLE_FK;

drop index ID_SEARCH_ARTICLES_FK;

drop index RSID_ARTICLE_PK;

drop table RSID_ARTICLE;

drop index TRUST_CRITERIA_PK;

drop table TRUST_CRITERIA;
...
alter table ARTICLE_TRUST_CRITERIA
   add constraint FK_ARTICLE__TRUST_ART_TRUST_CR foreign key ()
...
alter table RSID_ARTICLE
   add constraint FK_RSID_ART_FILE_ID_A_GT_FILE_ foreign key (, RSID)
      references GT_FILE_DATA (FILE_ID, FILE_RSID)
      on delete restrict on update restrict;
